...
public class DatabaseUpdate {
	...
	public static void main(String args[]) {
		...
		try {
			...
			Collection<IAchievement> testachievements2 = handler.getAllAchievementsFromUser(userid1);
			...
			Collection<IBeerPost> testposts2 = handler.getAllPostsFromBar(barid1); //sollte Post1,2 liefern
			Collection<IBeerPost> testposts3 = handler.getAllPostsFromBar(barid2); //sollte Post3,4,5 liefern
			Collection<IBeerPost> testposts4 = handler.getAllPostsFromUser(userid1); //sollte Post1,3 liefern
			Collection<IBeerPost> testposts5 = handler.getAllPostsFromUser(userid2); //sollte Post2,5 liefern
			Collection<IBeer> testbeers5 = handler.getAllBeersFromBar(barid1); //sollte Gösser und Stiegl liefern 
			Collection<IBeer> testbeers6 = handler.getAllBeersFromBar(barid2); //sollte Ottakringer und Starkenberger liefern
			...
			// delete tests
			handler.deletePost(post1); Collection<IBeer> testbeers7 = handler.getAllBeersFromBar(barid1); //sollte nur Stiegl liefern
			...
			Collection<IBeerPost> testposts8 = handler.getAllPosts(); //sollte Post2,4,5 liefern handler.deleteBeer(beerid3);
