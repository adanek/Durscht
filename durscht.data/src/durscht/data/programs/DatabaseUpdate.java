...
public class DatabaseUpdate {
	...
	public static void main(String args[]) {
		...
		try {
			...
			// // create new users
			// int userid1 = handler.createUser("admin", "admin@gmx.at",
			// "admin", true).getId();
			// int userid2 = handler.createUser("user2", "user2@gmx.at",
			// "user2", false).getId();
			// int userid3 = handler.createUser("user3", "user3@gmx.at",
			// "user3", false).getId();
			//
			// // create achievement critera
			// int crit1 =
			// handler.createAchievementCriterion(AchievementCriterionType.TOTAL_POSTS,
			// 5)
			// .getId();
			// int crit2 = handler
			// .createAchievementCriterion(AchievementCriterionType.TOTAL_POSTS,
			// 10).getId();
			// int crit3 = handler
			// .createAchievementCriterion(AchievementCriterionType.TOTAL_POSTS,
			// 20).getId();
			// int crit4 =
			// handler.createAchievementCriterion(AchievementCriterionType.WEEK_POSTS,
			// 3)
			// .getId();
			// int crit5 =
			// handler.createAchievementCriterion(AchievementCriterionType.WEEK_POSTS,
			...
			//
			// // create new beers
			// int beerid1 = handler.createBeer("Gösser", "Radler",
			// "Herbes österreichisches Bier",
			// false).getId();
			// int beerid2 = handler.createBeer("Stiegl", "Goldlager",
			// "Originales traditionelles Salzburger Bier", true).getId();
			// int beerid3 = handler.createBeer("Ottakringer", "Helles",
			// "Traditionelles Wiener Bier",
			// false).getId();
			// int beerid4 = handler.createBeer("Starkenberger", "Märzen",
			// "Heimisches Bier aus dem Schloss Starkenberg in Tarrenz",
			// true).getId();
			//
			// // create new Bars
			// int barid1 = handler.createBar("Theresien Bräu", 47.269258,
			// 11.4040792,
			...
			//
			// // create posts
			// int post1 = handler.createPost(barid1, beerid1, userid1, 3.0, 2,
			// "Post1").getId();
			// int post2 = handler.createPost(barid1, beerid2, userid2, 3.0, 2,
			// "Post2").getId();
			// int post3 = handler.createPost(barid2, beerid3, userid1, 3.0, 2,
			// "Post3").getId();
			// int post4 = handler.createPost(barid2, beerid4, userid3, 3.0, 2,
			// "Post4").getId();
			// int post5 = handler.createPost(barid2, beerid3, userid2, 3.0, 2,
			// "Post5").getId();
			//
			 ...
			 * = handler.getAllPosts();
			 * 
			 * // test all criterion Collection<IAchievementCriterion>
			 * testachcrit1 = handler .getAllCriterionFromAchievement(achid1);
			 ...
			 * handler.assignAchievementToUser(userid1, achid1);
			 * handler.assignAchievementToUser(userid1, achid2);
			 * Collection<IAchievement> testach1 =
			 * handler.getAllAchievementsFromUser(userid1);
			 * 
			 ...
			 * handler.getAllPostsFromBar(barid1); // Post1,2
			 * 
			 * Collection<IBeerPost> testposts3 =
			 * handler.getAllPostsFromBar(barid2); // Post 3,4,5
			 * 
			 * Collection<IBeerPost> testposts4 =
			 * handler.getAllPostsFromUser(userid1); // Post1,3
			 * 
			 * Collection<IBeerPost> testposts5 =
			 * handler.getAllPostsFromUser(userid2); // Post 2,5
			 * 
			 * Collection<IBeer> testbeers7 =
			 * handler.getAllBeersFromBar(barid1); // sollte Gösser und Stiegl
			 * liefern Collection<IBeer> testbeers8 =
			 ...
			 * testbeers9 = handler.getAllBeersFromBar(barid1); // sollte nur
			...
			int crit4 = handler.createAchievementCriterion(
					AchievementCriterionType.MONTH_POSTS, 10).getId();
			int crit5 = handler.createAchievementCriterion(
					AchievementCriterionType.MONTH_POSTS, 20).getId();
			int crit6 = handler.createAchievementCriterion(
					AchievementCriterionType.MONTH_POSTS, 50).getId();

			int achid4 = handler
					.createAchievement("10 posts in one month",
							"The user will get this achievement when he makes 10 posts in one month")
					.getId();
			int achid5 = handler
					.createAchievement("20 posts in one month",
							"The user will get this achievement when he makes 20 posts in one month")
					.getId();
			int achid6 = handler
					.createAchievement("50 posts in one month",
							"The user will get this achievement when he makes 50 posts in one month")
					.getId();
			...
			handler.assignCriterionToAchievement(23, crit4);
			handler.assignCriterionToAchievement(24, crit5);
			handler.assignCriterionToAchievement(25, crit6);
